    ...
    return (
        <>
            <SEO
                ...
                keywords="penthouse automation, luxury apartment control, high-rise systems, smart condo, high-end apartment automation"
                canonical="/penthouses"
            />
            <Hero
                title="Penthouses"
                subtitle="Precision living, above the noise."
                bgImage="/assets/penthouse_hero_v2.webp"
            >
            ...
            <div className="w-full h-[60vh] relative overflow-hidden my-12">
                <img
                    src="/assets/penthouse_detail_v2.webp"
