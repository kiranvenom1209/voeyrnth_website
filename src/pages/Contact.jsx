    ...
    return (
        <>
            <SEO
                ...
                keywords="private demo, consultation, contact voerynth"
                canonical="/contact"
            />
            <Hero
            ...
            <div className="text-center py-8">
                <Link to="/process" className="text-xs font-light text-white/40 hover:text-[#C9A961] transition-colors duration-200 tracking-widest uppercase border-b border-transparent hover:border-[#C9A961]/30 pb-1">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className="w-full bg-white/[0.02] border border-white/10 px-6 py-4 text-white/90 text-left focus:border-[#C9A961]/40 focus:bg-[#0A0A0A] focus:outline-none transition-all duration-200 flex justify-between items-center"
                                >
