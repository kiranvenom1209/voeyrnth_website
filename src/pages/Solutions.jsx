                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        ...
                        <div className="pt-8 flex flex-col md:flex-row justify-center items-center gap-6 flex-wrap">
                            <Link
                                to="/platform"
                                className="px-8 py-3 border border-white/10 text-white/60 text-xs tracking-widest uppercase hover:bg-white/[0.03] hover:border-white/30 transition-all duration-200"
                            >
                            ...
                            <Link
                                to="/contact"
                                className="px-8 py-3 bg-[#D4AF37] text-black text-xs tracking-widest uppercase font-medium hover:bg-[#C9A961] transition-all duration-200 shadow-lg shadow-[#D4AF37]/10"
                            >
