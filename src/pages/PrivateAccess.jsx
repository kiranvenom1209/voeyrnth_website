                        ...
                        >
                            ...
                            <div className="space-y-2 relative">
                                ...
                                >
                                    ...
                                    <span className={`transform transition-transform duration-500 ${interestOpen ? 'rotate-180' : ''}`}>
                            ...
                            <div className="pt-4 text-center">
                                <button
                                    type="submit"
                                    className="border border-[#D4AF37]/30 text-[#C9A961] px-10 py-3 text-sm tracking-widest hover:bg-[#D4AF37]/5 hover:border-[#D4AF37]/50 transition-all duration-700"
                                >
