    ...
    return (
        <>
            ...
            <Hero
                ...
                bgImage="/assets/process_hero_bg_v2.webp" // Placeholder - will need asset or fallback
            >
            ...
            <Section className="border-t border-white/5 bg-[#080808]">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <Link
                        to="/contact"
                        className="inline-block bg-[#D4AF37] text-black px-8 py-4 text-sm tracking-widest hover:bg-[#C9A961] transition-all duration-200 font-medium shadow-lg shadow-[#D4AF37]/10"
                    >
                        INITIATE DISCOVERY
                    </Link>
                </div>
