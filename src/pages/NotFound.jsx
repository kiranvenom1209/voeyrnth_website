    ...
    return (
        <>
            ...
            <Hero
                ...
                bgImage="/assets/home_hero_bg_v2.webp"
            >
                <div className="max-w-2xl mx-auto text-white/40 text-sm leading-loose mb-12 font-light">
                    ...
                    <Link
                        to="/"
                        className="border-b border-[#D4AF37]/30 pb-1 text-[#C9A961] hover:text-white transition-colors duration-200 tracking-widest uppercase text-xs"
                    >
                        Return to Signal
                    </Link>
                </div>
