    ...
    return (
        <>
            <SEO
                ...
                keywords="voerynth platform, iceberg architecture, control foundation, failure isolation"
                canonical="/platform"
            />
            <Hero
                title="The Platform"
            ...
            <section className="bg-gradient-to-b from-[#080808] to-[#0A0A0A] border-y border-[#D4AF37]/10 py-24 relative overflow-hidden">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(212,175,55,0.04) 0%, rgba(212,175,55,0) 70%)' }} />
                    ...
                    <div className="space-y-6 mb-16">
                        {layers.map((layer, idx) => (
                            <m.div
                                ...
                                className={`${layer.bgColor} ${layer.borderColor} border p-8 backdrop-blur-sm hover:border-opacity-40 transition-all duration-200`}
                            >
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {principles.map((principle, idx) => (
                            <m.div
                                ...
                                className="p-8 border border-[#D4AF37]/10 hover:border-[#D4AF37]/20 hover:bg-white/[0.015] transition-all duration-200"
                            >
                    ...
                    >
                        ...
                        <div className="space-y-4 text-white/40 text-sm leading-loose font-light">
                            ...
                            <div className="pt-8">
                                <Link
                                    to="/specs"
                                    className="inline-block px-8 py-3 border border-white/10 text-white/60 text-xs tracking-widest uppercase hover:bg-white/[0.03] hover:border-white/30 transition-all duration-200"
                                >
