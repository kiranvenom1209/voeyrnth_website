        ...
        <>
            ...
            <section className="relative h-screen flex flex-col justify-center items-center text-center px-6 overflow-hidden">
                ...
                >
                    ...
                    <div className="flex justify-center gap-4 mb-16 flex-wrap">
                        <Tag text={t('home.tags.local_first')} />
                        <Tag text={t('home.tags.zero_cloud')} />
                        <Tag text={t('home.tags.deterministic')} />
                        <Tag text={t('home.tags.adaptive')} />
                    </div>

                    <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
                        <SmartLink to="/contact" className="bg-[#D4AF37] text-black px-8 py-3 text-sm tracking-widest hover:bg-[#C9A961] transition-all duration-200 w-full md:w-auto font-medium shadow-lg shadow-[#D4AF37]/10">
                            {t('home.hero.request_demo')}
                        </SmartLink>
                        <SmartLink to="/platform" className="border border-white/15 text-white/90 px-8 py-3 text-sm tracking-widest hover:border-[#D4AF37]/40 hover:bg-white/[0.03] transition-all duration-200 w-full md:w-auto backdrop-blur-sm">
                            {t('home.hero.explore_platform')}
                        </SmartLink>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
                    <div className="text-center lg:text-left">
                        <div className="flex items-center justify-center lg:justify-start gap-3 mb-6">
                            ...
                            <span className="text-[#C9A961] text-xs font-mono tracking-widest uppercase">Live Environment Validation</span>
                        </div>
                        ...
                        <p className="text-white/50 leading-loose text-sm font-light mb-10 max-w-lg mx-auto lg:mx-0">
                            An inside look at {BRAND_NAME} architected to autonomously manage a multi-level estate. Discover the continuous zero-cloud logic, sensory awareness, and deterministic fallback systems deployed natively in a live luxury environment.
                        </p>
                        <SmartLink
                            to="/case-studies/ayanthiara-chitrakoot"
                            className="inline-block border border-[#D4AF37]/30 text-[#C9A961] px-8 py-3 text-sm tracking-widest hover:bg-[#D4AF37]/5 hover:border-[#D4AF37]/50 transition-all duration-200"
                        >
                            READ THE CASE STUDY
                        </SmartLink>
            ...
            <Section className="mb-24">
                <div className="bg-gradient-to-br from-[#0D0D0D] to-[#0A0A0A] border border-[#D4AF37]/15 p-12 relative overflow-hidden shadow-2xl text-center">
                    <div className="absolute top-0 right-0 w-64 h-64 rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(212,175,55,0.08) 0%, rgba(212,175,55,0) 70%)' }}></div>
