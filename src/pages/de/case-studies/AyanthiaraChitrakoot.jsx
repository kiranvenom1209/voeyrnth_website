                    ...
                    >
                        ...
                        <div className="mt-6 sm:mt-8 flex justify-center sm:justify-start">
                            ...
                            >
                                ...
                                <span>Preprint über lokales LLM lesen (PDF)</span>
                    ...
                    <div className="mb-24">
                        ...
                        <div className="w-full pb-4">
                            <div className="flex flex-col md:flex-row flex-wrap items-center justify-center gap-6 lg:gap-8 w-full px-2 lg:px-4">
                                {[
                                    { title: "Geräte & Signale", desc: "Sensors, Cameras, Zustände", icon: Activity },
                                    { title: "Home Assistant", desc: "Lokale Zustandsmaschine & Kern", icon: Server },
                                    { title: "Neural Core", desc: "LLM-Reasoning & Intention", icon: Brain },
                                    { title: "Automatisierungen", desc: "YAML-Logik & Ausführung", icon: Cpu },
