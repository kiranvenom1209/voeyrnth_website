    ...
    return (
        <>
            <SEO
                ...
                keywords="interface design, calm technology, minimalist ui, control interfaces"
                canonical="/design"
            />
            <Hero
                title="Design That Behaves"
                subtitle="Authority without aggression."
                bgImage="/assets/design_hero_bg_v2.webp"
            >
                ...
                <div className="max-w-4xl mx-auto space-y-24">
                    {principles.map((principle, idx) => (
                        <m.div
                            ...
                            className="border-l border-[#D4AF37]/20 pl-8 md:pl-12 py-2 hover:border-[#D4AF37]/40 transition-all duration-200"
                        >
