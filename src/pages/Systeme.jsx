    ...
    return (
        <>
            <SEO
                ...
                keywords="core architecture, deterministic control, redundancy, system reliability"
                canonical="/systeme"
            />
            <Hero
                title="Système"
                subtitle="Infrastructure, built to last."
                bgImage="/assets/systeme_hero_bg_v2.webp"
            >
            ...
            <Section className="py-12 border-t border-white/5">
                <div className="text-center">
                    <Link to="/specs" className="text-sm font-light text-[#C9A961] hover:text-white transition-colors duration-200 tracking-wide border-b border-[#C9A961]/30 pb-1">
