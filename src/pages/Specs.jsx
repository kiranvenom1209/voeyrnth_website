    ...
    return (
        <>
            ...
            <Hero
                ...
                bgImage="/assets/specs_hero_bg_v2.webp" // Placeholder
            >
                    ...
                    <div className="space-y-4">
                        {layers.map((l, idx) => (
                            <m.div
                                ...
                                className="group relative border border-white/10 bg-[#0A0A0A] hover:border-[#D4AF37]/30 transition-all duration-200 overflow-hidden"
                            >
                                ...
                                <div className="p-8 md:flex items-center gap-12">
                                    <div className="md:w-1/6 mb-4 md:mb-0">
                                        <span className="text-4xl text-white/10 font-mono tracking-tighter group-hover:text-[#D4AF37]/20 transition-colors duration-200">
                                            {l.layer}
                                        </span>
                                    </div>
                                ...
                                <div key={i} className="flex gap-16 md:gap-32 items-center">
                                    {[
                                        ...
                                        <div key={idx} className="flex-shrink-0 group">
                                            ...
                                            <span className="text-xl md:text-2xl font-light text-white/40 tracking-widest hover:text-[#C9A961] transition-colors duration-200 cursor-default uppercase whitespace-nowrap">
                                                {p.name}
                                            </span>
                                        </div>
                                    ))}
