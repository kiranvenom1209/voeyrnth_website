    ...
    return (
        <footer className="py-12 border-t border-[#D4AF37]/10 text-center relative z-10 bg-[#060606]">
            ...
            <ul className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-8 mb-8 text-xs tracking-widest uppercase text-white/40 font-light p-0 w-full">
                ...
                <li>
                    <SmartLink to="/data-sovereignty" className="hover:text-[#C9A961] transition-colors duration-500">Data Sovereignty</SmartLink>
                </li>
                <li className="hidden md:block">
                    <span className="text-white/20">|</span>
                </li>
                ...
                <li>
                    <SmartLink to="/process" className="hover:text-[#C9A961] transition-colors duration-500">Methodology</SmartLink>
                </li>
                <li className="hidden md:block">
                    <span className="text-white/20">|</span>
                </li>
                <li>
                    <SmartLink to="/specs" className="hover:text-[#C9A961] transition-colors duration-500">System Specs</SmartLink>
                </li>
            </ul>
