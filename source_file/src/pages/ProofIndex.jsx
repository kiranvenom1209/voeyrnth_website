...
const ProofIndex = () => {
    return (
        <>
            <SEO
                title="Proof of Commissioning | Vœrynth"
            ...
            <section className="relative h-[80vh] flex flex-col justify-center items-center text-center px-6 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    {/* Placeholder for the "minimalist black binder" image */}
                    ...
                    {[
                        ...
                        <SmartLink key={idx} to={card.link} className="block group">
                            <motion.div
                                ...
                                className="p-8 border border-white/5 bg-[#0C0C0C] h-full relative overflow-hidden group-hover:border-[#D4AF37]/30 transition-all duration-500"
                            >
