...
const Architecture = () => {
    return (
        <>
            <SEO
                title="System Architecture | Vœrynth"
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <motion.div
                                ...
                                className="p-8 border border-white/5 bg-white/[0.02] hover:border-[#D4AF37]/20 transition-colors duration-500 group"
                            >
                        ...
                        <div className="grid md:grid-cols-5 gap-8 md:gap-4">
                            {[
                                ...
                                <div key={idx} className="relative pl-12 md:pl-0 md:text-center group">
                                    ...
                                    {/* Dot */}
                                    <div className="absolute left-[-1px] top-2 w-2.5 h-2.5 rounded-full bg-[#080808] border border-[#D4AF37] md:static md:mx-auto md:mb-6 md:w-3 md:h-3 ring-4 ring-[#080808] group-hover:bg-[#D4AF37] transition-colors duration-500" />
