...
const ProofCommissioning = () => {
    return (
        <>
            <SEO
                title="Commissioning & Acceptance | Vœrynth"
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        {[
                            ...
                            <motion.div
                                ...
                                className="p-8 border border-white/5 bg-[#0C0C0C] text-center group hover:border-[#D4AF37]/30 transition-all duration-500"
                            >
